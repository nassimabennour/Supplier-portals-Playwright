...
export const SUPPLIER_USER_DATA: Record<string, PortalSupplierUserData> = {
  ...
  CH:  { supplierName: '3KV GmbH', jobCategory: 'Automation Tester', emailDomain: 'proton.me', successMessage: 'Benutzer beim Lieferanten erfolgreich angelegt und verknüpft!' },
